...
function OrderDetailPage() {
  ...
  <NavLink
    ...
    className={({ isActive }) =>
      `flex items-center gap-2 rounded-lg px-4 py-2 border transition ${
        isActive
  ...
  {paid ? (
    ...
    <div className="flex items-center gap-2 rounded-lg px-4 py-2 border border-base-300 opacity-50 cursor-not-allowed">
